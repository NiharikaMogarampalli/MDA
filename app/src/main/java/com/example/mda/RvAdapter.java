    ...
    public void onBindViewHolder(@NonNull RvViewHolder holder, final int position) {
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                row_index=position;
                if(row_index==0)
                    context.startActivity(new Intent(context,ServiceSocialMediaMarketing.class));
                else if(row_index==1)
                    context.startActivity(new Intent(context,ServiceDigitalMarketing.class));
                else if(row_index==2)
                    context.startActivity(new Intent(context,ServiceSEO.class));
                else if(row_index==3)
                    context.startActivity(new Intent(context,ServicesContentMarketing.class));
                else if(row_index==4)
                    context.startActivity(new Intent(context,ServicesGoogleAds.class));
                else if(row_index==5)
                    context.startActivity(new Intent(context,ServicePayPerClick.class));
                else if(row_index==6)
                    context.startActivity(new Intent(context,ServicesGrowBusiness.class));
